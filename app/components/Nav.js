      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <Popover className="relative">
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl bg-green-100 shadow-lg ring-1 ring-gray-900/5">
                <div className="p-4">
                  {products.map((item) => (
                    <div
                      key={item.name}
                    ...
                    >
                      <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-green-50 group-hover:bg-green-100">
                        <item.icon
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <button className="bg-white text-[#40572a] p-3 font-semibold rounded-md">
            Login
          </button>
        </div>
      </nav>
